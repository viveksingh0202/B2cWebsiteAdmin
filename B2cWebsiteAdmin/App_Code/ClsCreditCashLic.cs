...
{
    public class ClsCreditCashLic : GetConnectionString
    {
        public DataTable GetDataCreditLic()
        {
            try
            {
                string strcon = getconnection();
                SqlConnection con = new SqlConnection(strcon);
                SqlCommand cmd = new SqlCommand("Sp_TblCreateCardLicGet", con);
        ...
        public int DataInsertCreditLic(string image1, string image2, string Heading1, string Heading2, string content1, string buttonLink, string create_updateby)
        {
            try
            {
                ...
                string strcon = getconnection();
                SqlConnection con = new SqlConnection(strcon);
                SqlCommand cmd = new SqlCommand("Sp_TblCreateCardLic", con);
                cmd.CommandType = CommandType.StoredProcedure;
