    ...
    public class ClsBBPS:GetConnectionString
    {
        public DataTable GetDataBBPS()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("dbo.Sp_TblBBPSGet", con);
        ...
        public int DataInsertBBPS(string image1, string image2, string Heading1, string Heading2, string content1,string paragraph1, string paragraph2, string paragraph3, string paragraph4, string buttonLink, string create_updateby)
        {
            try
            {
