...
{
    public class ClsFastTag:GetConnectionString
    {
        public DataTable GetDataFastTag()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Sp_TblFastTagGet", con);
        ...
        public int DataInsertFastTag(string image1, string image2, string image3, string Heading1, string Heading2, string Heading3, string content1, string content2, string content3,string buttonLink, string create_updateby)
        {
            try
            {
                ...
                string strcon = getconnection();
                SqlConnection con = new SqlConnection(strcon);
                SqlCommand cmd = new SqlCommand("Sp_TblFastTag", con);
                cmd.CommandType = CommandType.StoredProcedure;
