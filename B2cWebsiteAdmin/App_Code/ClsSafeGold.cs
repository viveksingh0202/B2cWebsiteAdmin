...
{
    public class ClsSadeGold:GetConnectionString
    {
        public DataTable GetDataSafeGOld()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Sp_TblSafeGoldGet", con);
        ...
        public int DataInsertSafeGold(string image1, string image2, string Heading1, string Heading2, string content1, string content2, string buttonLink, string create_updateby)
        {
            try
            {
                ...
                string strcon = getconnection();
                SqlConnection con = new SqlConnection(strcon);
                SqlCommand cmd = new SqlCommand("Sp_TblSafeGold", con);
                cmd.CommandType = CommandType.StoredProcedure;
