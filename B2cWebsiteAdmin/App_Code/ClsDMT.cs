    ...
    public class ClsDMT:GetConnectionString
    {
        public DataTable GetDataDmt()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Sp_TblDMTGet", con);
         ...
         public int DataInsertDMt(string  image1, string image2, string image3,string Heading1, string Heading2, string Heading3, string content1, string content2, string content3, string paragraph1, string paragraph2, string paragraph3, string buttonLink, string create_updateby)
        {
            try
            {
