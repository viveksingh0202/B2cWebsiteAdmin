<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule/Admin.Master" AutoEventWireup="true" CodeBehind="AdminDashboard.aspx.cs" Inherits="B2cWebsiteAdmin.AdminModule.AdminDashboard" %>
                                                            ...
                                                            <div class="tab-pane active" id="home3" role="tabpanel">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <img src="assets/images/product/prod2.jpg" alt="prod img" class="img-fluid"></td>
                                                                            <td>PNG002344</td>
                                                                            <td>John Deo</td>
                                                                            <td>05-01-2017</td>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <img src="assets/images/product/prod3.jpg" alt="prod img" class="img-fluid"></td>
                                                                            <td>PNG002653</td>
                                                                            <td>Eugine Turner</td>
                                                                            <td>04-01-2017</td>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <img src="assets/images/product/prod4.jpg" alt="prod img" class="img-fluid"></td>
                                                                            <td>PNG002156</td>
                                                            ...
                                                            <div class="tab-pane" id="messages3" role="tabpanel">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <img src="assets/images/product/prod1.jpg" alt="prod img" class="img-fluid"></td>
                                                                            <td>PNG002413</td>
                                                                            <td>Jane Elliott</td>
                                                                            <td>06-01-2017</td>
                                                    ...
                                                    <div class="card-block">
                                                        <ul class="feed-blog">
                                                            ...
                                                            <li class="diactive-feed">
                                                                ...
                                                                <p class="m-b-15 m-t-15" hii=""></p>
                                                                <b>@everone</b> Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                                            </li>
                                                            <li class="active-feed">
                                                                <div class="feed-user-img">
                                                                    <img src="assets/images/avatar-3.jpg" class="img-radius " alt="User-Profile-Image">
