<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule/Admin.Master" AutoEventWireup="true" CodeBehind="BBPS.aspx.cs" Inherits="B2cWebsiteAdmin.AdminModule.BBPS" %>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group row">
                                                            <i class="col-sm- fa fa-pencil" aria-hidden="true" style="margin-top: 10px; margin-left: 20px"></i>
                                                            <div class="col-sm-11">
                                                                <asp:Label ID="lblcontent" runat="server" class="col-form-label fillData"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <i class="col-sm- fa fa-pencil" aria-hidden="true" style="margin-top: 10px; margin-left: 20px"></i>
                                                            <div class="col-sm-11">
                                                                <asp:Label ID="lblparagraph4" runat="server" class="col-form-label fillData"></asp:Label>
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <i class="col-sm- fa fa-pencil" aria-hidden="true" style="margin-top: 10px; margin-left: 20px"></i>
                                                            <div class="col-sm-11">
                                                                <asp:Label ID="lblparagraph5" runat="server" class="col-form-label fillData"></asp:Label>
                                                            </div>
                                                ...
                                                <div class="container">
                                                    <div class="content">
                                                        <for>
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <strong>Heading First :</strong><asp:TextBox ID="txtfirstheading" runat="server" placeholder="Type your first heading"></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <strong>Heading Second :</strong>
                                                                    <asp:TextBox ID="txtsecondheading" runat="server" placeholder="Type your second heading"></asp:TextBox>
