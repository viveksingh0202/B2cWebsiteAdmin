<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule/Admin.Master" AutoEventWireup="true" CodeBehind="Safe_Gold.aspx.cs" Inherits="B2cWebsiteAdmin.AdminModule.Safe_Gold" %>
...
*/
    ...
    <link href="../assets/css/styleimages2.css" rel="stylesheet" />
</asp:Content>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-11">
                                                                <asp:Label ID="lblheadig1" runat="server" class="col-form-label fillData"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <i class="col-sm- fa fa-pencil" aria-hidden="true" style="margin-top: 10px; margin-left: 20px"></i>
                                                            <div class="col-sm-11">
                                                                <asp:Label ID="lblheadig2" runat="server" class="col-form-label fillData"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        ...
                                                        <for>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <asp:TextBox ID="txtcontent1" runat="server" placeholder="Type your content "></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <strong>Content Second :</strong>
                                                                    <asp:TextBox ID="txtcontent2" runat="server" placeholder="Type your content second"></asp:TextBox>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <asp:Button ID="btn_submit" OnClick="btn_submit_Click" runat="server" CssClass="btn btn-success" Text="Submit" />
                                                                </div>
                                                                 <div class="col-sm-6">
