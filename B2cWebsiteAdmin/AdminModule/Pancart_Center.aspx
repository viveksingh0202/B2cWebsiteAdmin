<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule/Admin.Master" AutoEventWireup="true" CodeBehind="Pancart_Center.aspx.cs" Inherits="B2cWebsiteAdmin.AdminModule.Pancart_Center" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <%--   <style>
    ...
    </style>--%><link href="../assets/css/styleimages3.css" rel="stylesheet" />
</asp:Content>
                ...
                <div class="main-body">
                    <section class="get-in-touch">
                        ...
                        <for class="contact-form row" style="margin-top: -2.5rem">
                            ...
                            <div class="form-field col-lg-6">
                                <asp:TextBox ID="txtParagraph4" runat="server" class="input-text js-input" placeholder="Type Fourth Paragraph ..."></asp:TextBox>
                            </div>
