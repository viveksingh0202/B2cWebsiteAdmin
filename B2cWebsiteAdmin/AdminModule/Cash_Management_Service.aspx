<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule/Admin.Master" AutoEventWireup="true" CodeBehind="Cash_Management_Service.aspx.cs" Inherits="B2cWebsiteAdmin.AdminModule.Cash_Management_Service" %>
                                                    ...
                                                    <div class="content">
                                                        <for>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <asp:Button ID="btn" runat="server" OnClick="btn_Click" CssClass="btn btn-success" Text="Submit" />
                                                                </div>
                                                                 <div class="col-sm-6">
                                                                 <asp:Label ID="lblmassage" runat="server"></asp:Label>                                                                </div>
                                                            </div>
                                                        </for>
                                                    </div>
                                                </div>
