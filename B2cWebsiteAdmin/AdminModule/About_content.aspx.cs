...
namespace B2cWebsiteAdmin.AdminModule
{
    ...
    public partial class About_content : System.Web.UI.Page
    {
        ...
        void DataBind1()
        {
            ...
            try
            {
                DataTable dt = clsAboutMaster.AboutContent();
                if (dt.Rows.Count > 0)
                {
        ...
        protected void btn_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "";
                int fileSize1 = 0;
                /*string txtcontent11 = "";*/      /*lblheading11 = "",*//* lblcontent1s11 = "",*//*lblcontents12="",*/ /*s1txtlink11 = "",*/  /*txtcontent12="";*/
                ...
                //else
                //{
                //    txtcontent11 = ViewState["content1"].ToString();
                //}
                ...
                //{
                //    txtcontent12 = txtcontent.Text;
                //}
                //else
                //{
                //    lblcontents12 = ViewState["Content2"].ToString();
                //}
                ...
                if (status == true)
                {
                    ...
                    SqlCommand cmd = new SqlCommand("Sp_TblAboutMasterContent1", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@image", filename);
                    //cmd.Parameters.AddWithValue("@Content1", txtcontent12);
