<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule/Admin.Master" AutoEventWireup="true" CodeBehind="OurMission.aspx.cs" Inherits="B2cWebsiteAdmin.AdminModule.OurMission" %>
                                                ...
                                                <div class="tab-pane active" id="SliderSectionOne" runat="server">
                                                    <div class="card">
                                                        <div class="card-header" style="padding: 12px 5px 5px 15px; background-color: #396EB4">
                                                            <h4 style="color: white">Our Mission Details</h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
