<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule/Admin.Master" AutoEventWireup="true" CodeBehind="Join.aspx.cs" Inherits="B2cWebsiteAdmin.AdminModule.Join" %>
                                                ...
                                                <div class="tab-pane active" id="SliderSectionOne" runat="server">
                                                    <div class="card">
                                                        <div class="card-header" style="padding: 12px 5px 5px 15px; background-color: #396EB4">
                                                            <h4 style="color: white">Join Details</h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-11">
                                                                <asp:Label ID="lbljoinone" runat="server" class="col-form-label fillData"></asp:Label>
                                                            </div>
                                                            <div class="form-group row">
                                                                <i class="col-sm- fa fa-pencil" aria-hidden="true" style="margin-top: 10px; margin-left: 20px"></i>
                                                                <div class="col-sm-11">
                                                                    <asp:Label ID="lbljointwo" runat="server" class="col-form-label fillData"></asp:Label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <i class="col-sm- fa fa-pencil" aria-hidden="true" style="margin-top: 10px; margin-left: 20px"></i>
                                                                <div class="col-sm-11">
                                                                    <asp:Label ID="lbljoinlink" runat="server" class="col-form-label fillData"></asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <section class="get-in-touch">
                        ...
                        <for class="contact-form row" style="margin-top: -2.5rem">
                            <div class="form-field col-lg-6 ">
                                ...
                                <asp:TextBox ID="txtjoinone" runat="server" class="input-text js-input" placeholder="Heading ..."></asp:TextBox>
                            </div>
                            <div class="form-field col-lg-6 ">

                                <asp:TextBox ID="txtjointwo" runat="server" class="input-text js-input" placeholder="Type  your Content ..."></asp:TextBox>
                            </div>
                            <div class="form-field col-lg-6 ">

                                <asp:TextBox ID="txtjointhr" runat="server" class="input-text js-input" placeholder="type yourlink ..."></asp:TextBox>
                            </div>
