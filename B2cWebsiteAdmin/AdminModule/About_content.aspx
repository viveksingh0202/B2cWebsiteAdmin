<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule/Admin.Master" AutoEventWireup="true" CodeBehind="About_content.aspx.cs" Inherits="B2cWebsiteAdmin.AdminModule.About_content" %>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12" style="margin-top: 10px">
                                                    <div class="card p-0">
                                                        ...
                                                        <%--<div class="card-body" style="background-color: #396EB4; color: white; font-family: sarif">
                                                            <h4>Button Link:</h4>
                                                             <asp:Label ID="lblLinrunat="server"></asp:Label>                                           
